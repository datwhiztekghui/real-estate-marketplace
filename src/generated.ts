...
export const realEstateMarketplaceAbi = [
    ...
    outputs: [
      ...
      },
      {
        ...
        components: [
          ...
          { name: 'yearBuilt', internalType: 'uint256', type: 'uint256' },
          { name: 'keyFeatures', internalType: 'string[]', type: 'string[]' },
          { name: 'amenities', internalType: 'string[]', type: 'string[]' },
  ...
  },
  {
    ...
    inputs: [
      ...
      { name: '_yearBuilt', internalType: 'uint256', type: 'uint256' },
      { name: '_keyFeatures', internalType: 'string[]', type: 'string[]' },
      { name: '_amenities', internalType: 'string[]', type: 'string[]' },
